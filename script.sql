...
-- -----------------------------------------------------
-- CREAR TABLAS DEPARTAMENTOS Y MUNICIPIOS POBLADAS
-- -----------------------------------------------------
...
INSERT INTO `municipios` (`idmunicipio`, `nommunicipio`, `iddepto`) VALUES
('05001', 'Medellín            ', '05'),
('05002', 'Abejorral           ', '05'),
('05004', 'Abriaquí            ', '05'),
('05021', 'Alejandria          ', '05'),
...
-- DATOS UN EMPLEADO DE PRUEBA

INSERT INTO `usuarios`(
  `cedula`, `nombres`, `apellidos`, `direccion`, `telefono`, `email`, `ciudad`, `fechanac`, `usuario`, `clave`
  ) VALUES (
  '123456789', 'Cristian Yamith', 'Salazar', 'Pasto', '123456789',
...
INSERT INTO `detallesrol`(`cedula`, `rol`) VALUES ('123456789', 2);
