<?php
    ...
    class Clientes extends Controller
    {
        ...
        public function editClientes($cedula){
            $this->session();
            $data = $this->model->getCliente($cedula);
            // $departamentos['departamentos'] = $this->model->getDepartamentos();
            $data['departamentos'] = $this->model->getDepartamentos();
            $this->views->getView($this, "editClientes", $data);
        }
        ...
        public function actualizarCliente(){
            ...
            if (empty($cedula) || empty($nombres) || empty($apellidos) || empty($direccion) || empty($telefono) || empty($email) || empty($municipio)  || empty($fechanac) ) {
                ...
                $data = $this->model->actualizarCliente($cedula, $nombres, $apellidos, $direccion, $telefono, $email, $municipio, $fechanac);
                // validar si usuario se registro con exito
                if ($data == "ok") {
                    $msg = "ok";
                } else {
